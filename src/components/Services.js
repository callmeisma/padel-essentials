  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="w-4/6 mx-auto py-10 space-y-4">
        <p className="pt-16 italic">
          We are your one stop solution for opening your Padel Club.
        </p>
        <h2 className="pb-6 text-4xl font-serif font-light">How We Work</h2>
        <p>
      ...
      <ul className="flex flex-col items-start">
        <li className="flex justify-center">
          ...
          <div className="w-1/2 p-6 pt-24 space-y-6">
        ...
        <li className="flex flex-row-reverse justify-center">
          ...
          <div className="w-1/2 p-6 pt-24 space-y-6">
            <h3 className="text-right font-serif text-3xl font-light">
